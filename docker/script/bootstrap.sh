...
pip3 install $PIP_OPTION protobuf==3.20.*
...
pip3 install $PIP_OPTION apache-airflow-providers-google==7.0.0
pip3 install $PIP_OPTION apache-airflow-providers-cncf-kubernetes==3.1.2
